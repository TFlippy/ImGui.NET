...
namespace ImGuiNET
{
    public unsafe partial struct ImGuiInputTextState
    {
        ...
        public delegate* unmanaged[Cdecl]<ImGuiInputTextCallbackData*, int> UserCallback;
    ...
    public unsafe partial struct ImGuiInputTextStatePtr
    {
        ...
        public IntPtr UserCallback { get => (IntPtr)NativePtr->UserCallback; set => NativePtr->UserCallback = (delegate* unmanaged[Cdecl]<ImGuiInputTextCallbackData*, int>)value; }
